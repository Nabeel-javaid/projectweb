    ...
    return (
        <div className='w-full h-screen p-12 mt-14 flex flex-row'>
            ...
            <div className='mt-2 bg-slate-200 p-3 rounded'>Arrival Airport<span>{departure_time} </span></div> */}
                    ...
                    <div className="mt-2 bg-slate-200 p-3 rounded">
                        Departure Time: <span><strong>{departure_time}</strong></span>
                    </div>
                    <div className="mt-2 bg-slate-200 p-3 rounded">
                        Departure Airport: <span><strong>{departure_airport}</strong></span>
                    </div>
                    <div className="mt-2 bg-slate-200 p-3 rounded">
                        Arrival Airport: <span><strong>{arrival_airport}</strong></span>
                    </div>

                    <div className='flex flex-row justify-between mt-5'>
                        <div className='text-lg font-medium ml-2'><strong>Price: ${price}</strong></div>
                    </div>
                </div>
            </div>
